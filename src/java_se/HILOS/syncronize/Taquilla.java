...
public class Taquilla {
	...
	private static Taquilla taquilla = new Taquilla(AFORO);// patron silgenton,
															// solo se llama el
															// objeto una vez
	...
	public void comprarEntrada(Cliente c) {
		nentradas--;
		System.out.println("(" + nentradas + ")" + c.getNombre()
				+ " ha comprado una entrada.");
		if (nentradas < 0)
			System.out
					.println("Taquillero, la has cagado: has vendido entradas que no tenías!!!");
	}
}
